...
const toolEndFields = [
  ...
  "output.artifact.a2uiSurface.components.*.text",
  "output.artifact.a2uiSurface.components.*.title",
  "output.artifact.a2uiSurface.components.*.label",
  "output.artifact.a2uiSurface.components.*.body",
  "output.artifact.a2uiSurface.components.*.content",
  "output.summary",
  "output.body",
];
