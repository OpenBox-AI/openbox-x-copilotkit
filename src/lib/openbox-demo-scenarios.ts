export const openBoxDemoScenarios = [
  ...
  },
  {
    ...
    reason:
      "OpenBox evaluates the final human-edited note before execution.",
  ...
  },
  {
    ...
    reason:
      "OpenBox requires human approval before issuing this credit memo.",
  ...
  },
  {
    ...
    reason:
      "OpenBox halted a critical production payment-control change.",
