...
export const useGenerativeUIExamples = () => {
  ...
  useOpenBoxCopilotKit({
    ...
    approvalParameters: z.object({
      ...
      workflowId: z.string().describe("OpenBox workflow ID from the approval_required tool result."),
      runId: z.string().describe("OpenBox run ID from the approval_required tool result."),
      activityId: z.string().describe("OpenBox activity ID from the approval_required tool result."),
      approvalId: z.string().optional().describe("OpenBox approval ID."),
      governanceEventId: z
        .string()
        .describe("OpenBox governance event ID from the approval_required tool result."),
      expiresAt: z
        .string()
        .optional()
